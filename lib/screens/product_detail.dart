...
import 'package:bridge_app/screens/favorite.dart'; // تأكد من استيراد صفحة المفضلات
      ...
      bottomNavigationBar: BottomNavBar(
        ...
        onTap: (i) {
          setState(() {
            ...
            // إذا ضغط المستخدم على صفحة المفضلة (مثلا رقم 3)
            if (i == 3) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => FavoritePage(
                    ...
                    cartItems: [], // يمكن تعديل لتمرير حقيبة التسوق
                  ),
                ),
              );
            }
